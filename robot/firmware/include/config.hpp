...
void pmotors_config(PrecisionMotor *pmotors)
{
	/* PMOTOR #[0] config */ {
		...
		pm._pid_speed.setK(0.060000, 0.00000, 0.10000);
	};
	/* PMOTOR #[1] config */ {
		auto &pm = pmotors[1];
		pm._e.set_inverted(true);
		pm._m.set_inverted(true);
		pm._pid_angle.setK(0.60000, 0.00000, 0.01000);
		pm._pid_speed.setK(0.060000, 0.00000, 0.06000);
	};
	/* PMOTOR #[2] config */ {
		auto &pm = pmotors[2];
		...
		pm._m.set_inverted(true);
		pm._pid_angle.setK(0.60000, 0.00000, 0.01000);
		pm._pid_speed.setK(0.060000, 0.00000, 0.12000);
	};
	/* PMOTOR #[3] config */ {
		auto &pm = pmotors[3];
		pm._e.set_inverted(true);
		pm._m.set_inverted(true);
		pm._pid_angle.setK(0.60000, 0.00000, 0.01000);
		pm._pid_speed.setK(0.060000, 0.00000, 0.15500);
	};    
